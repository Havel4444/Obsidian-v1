...
source "$OSH"/oh-my-bash.sh 2> ~/error.txt
...
alias puoff='pactl unload-module module-simple-protocol-tcp'
...
# Debido a problemas con 'OH MY BASH' que enviaba numeros al historias cree este 
# siguiente comando para rediregir el historias a un nuevo archivo de texto con un filtro.
# Alias con ejecucion de comando.
cph2() {
...
# Sobrescribir on. Esta configuracion esta activa por un ERROR con 'OH MY BASH'.
set +o noclobber
